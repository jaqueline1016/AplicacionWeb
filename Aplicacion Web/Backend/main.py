...
from Metodos.Comentario import *
...
@app.route('/getPeliculaClient', methods=['GET'])
def getPeliculaClient():
    respuesta = GetPeliculaClient(peliculas)
    return respuesta


@app.route('/SelecPelicula',methods=['POST'])
def SelecPeliculaClient():
    respuesta = SelecPelicula(request.json, peliculas)
    return respuesta

#este es para agregar a la playlist
@app.route('/AgregarPlaylist',methods=['POST'])
def AgregarPlaylist():
    respuesta = AgregarPlaylist(request.json)
    return respuesta
#este es para mostrar en la playlist 
@app.route('/MostrarenPlaylist',methods=['GET'])
def MostrarenPlaylist():
    respuesta = MostrarenPlaylist(playlist)
    return respuesta
...
#agregada 
@app.route('/AgregarComentarios', methods=['POST'])
def agregarComentarios():
    respuesta = AgregarComentarios(request.json, comentarios)
    return respuesta
#
